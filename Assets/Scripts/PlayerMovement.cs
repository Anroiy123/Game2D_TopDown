...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        // NẾU ĐANG NGỒI HOẶC ĐANG NÓI CHUYỆN THÌ KHÔNG LÀM GÌ CẢ (Không di chuyển)
        if (isSitting || isTalking) return;
    ...
    {
        // Nếu đang ngồi hoặc đang nói chuyện thì dừng hẳn vật lý
        if (isSitting || isTalking)
        {
